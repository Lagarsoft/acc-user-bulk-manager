    ...
    <div>
      ...
      <div className="flex items-center gap-3">
        <label className="cursor-pointer flex-1">
          <span className="block border border-dashed border-gray-300 rounded-md px-3 py-2 text-sm text-gray-500 hover:border-aps-blue hover:text-aps-blue truncate">
        ...
        <button
          ...
          className="shrink-0 bg-aps-blue text-white py-2 px-4 rounded-md text-sm font-medium hover:bg-aps-hover disabled:opacity-50 disabled:cursor-not-allowed"
        >
